...
urlpatterns = [
    ...
    path('junior-admin/deposits/<int:pk>/approve/',     views.junior_admin_approve_deposit,     name='ja_approve_deposit'),
    path('junior-admin/deposits/<int:pk>/reject/',      views.junior_admin_reject_deposit,      name='ja_reject_deposit'),
